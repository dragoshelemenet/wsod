...
const CATEGORY_LABEL = "Audio";
const BACK_HREF = "/audio";
const BACK_LABEL = "← Înapoi la audio";
  ...
  return (
    <main className="inner-page">
      ...
      <div className="inner-topbar">
        <Link href={BACK_HREF} className="back-link">
          {BACK_LABEL}
        </Link>
      </div>
      ...
      <section className="inner-section">
        ...
        <div className="owner-folder-section">
          <div className="owner-folder-section-head">
            <h2>{`Mai multe audio pentru ${item.owner.name}`}</h2>
          </div>

          <MediaGrid
            items={sameOwnerItems}
            emptyText="Nu există alte materiale audio momentan."
          />
        ...
        <div className="owner-folder-section">
          ...
          <div className="model-page-actions">
            <Link href={BACK_HREF} className="media-link">
              Vezi toate audio
            </Link>
          </div>
        </div>
