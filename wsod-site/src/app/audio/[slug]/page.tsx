...
const CATEGORY_LABEL = "audio" === "meta-ads" ? "Meta Ads" : "audio".charAt(0).toUpperCase() + "audio".slice(1);
const BACK_HREF = "/audio";
const BACK_LABEL = "audio" === "meta-ads" ? "← Înapoi la Meta Ads" : "← Înapoi la " + CATEGORY_LABEL.toLowerCase();
